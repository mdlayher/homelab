...
require (
	...
	github.com/gokrazy/firmware v0.0.0-20201217182957-d55a7b5197d7
	...
	github.com/gokrazy/kernel v0.0.0-20201226193831-57eb3fcca1ca
	github.com/gokrazy/rpi-eeprom v0.0.0-20200908032412-afe72d1e3a26
